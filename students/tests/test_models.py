...
class CourseAccessRestrictionTest(TestCase):
    ...
    def test_student_blocked_if_quiz_not_passed(self):
        ...
        self.assertIn(self.advanced_content.id, response.context['blocked_content_ids'])
        ...
        self.assertIn(self.advanced_content.id, second_response.context['blocked_content_ids'])
